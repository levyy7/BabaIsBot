...
class StrategistPrompt(BasePrompt):
    def __init__(self, path: Path = None):
        ...
        self.user_template = (self.prompt_path / "strategist" / "strategist.user.md").read_text()
    ...
    def format(self, belief_to_test: str, current_beliefs: str) -> Tuple[str, str]:
        ...
        return "", self.user_template.format(belief_to_test=belief_to_test, current_beliefs=current_beliefs)
