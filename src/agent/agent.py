...
class Agent:
    def __init__(self, baba_host_url: str, llm_host_url: str):
        ...
        self.tactician = Tactician(
            state_transition_function=self.runner.run_step_function,
            goal_condition_function=self.runner.run_goal_condition,
        )
    ...
    def run(
        ...
        while True:
            ...
            action_list = self.tactician.plan(start_state=initial_state, max_depth=500)
    ...
    def _execute_action_sequence(
        ...
        for action in action_list:
            ...
            simulated_state = self.runner.run_step_function(previous_state, action)
    ...
    def _generate_new_goals(self):
        self.runner.update_goal_condition_function_with_new_goal()
